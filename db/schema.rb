...
ActiveRecord::Schema.define(version: 20180812143410) do
  ...
  create_table "ss_confs", force: :cascade do |t|
    ...
    t.index ["registration_user_id"], name: "index_ss_confs_on_registration_user_id"
    t.index ["user_id"], name: "index_ss_confs_on_user_id"
  end
